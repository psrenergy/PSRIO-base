function ChartVue.add_line(self, e1, options)
    self:add("line", e1, options);
end

function ChartVue.add_line_categories(self, e1, label, options)
    self:add_category("line", e1, label, options);
end

function ChartVue.add_line_block_categories(self, e1, options)
    options = (options or {});
    self:add_block_category("line", e1, options);
end

function ChartVue.add_column_block_categories(self, e1, options)
    options = (options or {});
...
function ChartVue.add_line_stacking(self, e1, options)
    self:add("line_stacking", e1, options);
end

function ChartVue.add_line_stacking_categories(self, e1, label, options)
    self:add_category("line_stacking", e1, label, options);
end

function ChartVue.add_line_stacking_exclude_zeros(self, e1, options)
    self:add_exclude_zeros("line_stacking", e1, options);
end

function ChartVue.add_spline(self, e1, options)
    self:add("spline", e1, options);
end

function ChartVue.add_spline_categories(self, e1, label, options)
    self:add_category("spline", e1, label, options);
end

function ChartVue.add_waterfall_categories(self, e1, label, options)
    self:add_category("waterfall", e1, label, options);
end

function ChartVue.add_spline_exclude_zeros(self, e1, options)
    self:add_exclude_zeros("spline", e1, options);
end

function ChartVue.add_column(self, e1, options)
    self:add("column", e1, options);
end

function ChartVue.add_column_categories(self, e1, label, options)
    self:add_category("column", e1, label, options);
end

function ChartVue.add_categories(self, e1, label, options) --TODO: isso vai morrer
    self:add_category("column", e1, label, options);
end

function ChartVue.add_box_plot_categories(self, e1, e2, e3, e4, e5, label, options)
    self:add_category("box_plot", e1, e2, e3, e4, e5, label, options);
end

function ChartVue.add_errorbar_categories(self, e1, e2, label, options)
    self:add_category("errorbar", e1, e2, label, options);
end

function ChartVue.add_column_stacking(self, e1, options)
    self:add("column_stacking", e1, options);
end

function ChartVue.add_column_stacking_categories(self, e1, label, options)
    self:add_category("column_stacking", e1, label, options);
end

function ChartVue.add_column_percent(self, e1, options)
    self:add("column_percent", e1, options);
end

function ChartVue.add_column_percent_categories(self, e1, label, options)
    self:add_category("column_percent", e1, label, options);
end

function ChartVue.add_column_range(self, e1, e2, options)
    self:add("column_range", e1, e2, options);
end

function ChartVue.add_area(self, e1, options)
    self:add("area", e1, options);
end

function ChartVue.add_area_stacking(self, e1, options)
    self:add("area_stacking", e1, options);
end

function ChartVue.add_area_percent(self, e1, options)
    self:add("area_percent", e1, options);
end

function ChartVue.add_area_range(self, e1, e2, options)
    self:add("area_range", e1, e2, options);
end

function ChartVue.add_area_spline(self, e1, options)
    self:add("area_spline", e1, options);
end

function ChartVue.add_area_spline_stacking(self, e1, options)
    self:add("area_spline_stacking", e1, options);
end

function ChartVue.add_area_spline_percent(self, e1, options)
    self:add("area_spline_percent", e1, options);
end

function ChartVue.add_area_spline_range(self, e1, e2, options)
    self:add("area_spline_range", e1, e2, options);
end

function ChartVue.add_error_bar(self, e1, e2, options)
    self:add("error_bar", e1, e2, options);
end

function ChartVue.add_pie(self, e1, options)
    self:add("pie", e1, options);
end

function ChartVue.add_box_plot(self, e1, e2, e3, e4, e5, options)
    self:add("box_plot", e1, e2, e3, e4, e5, options);
end

function ChartVue.add_thermal_merit_order_curve(self, generation, cost)
...
function ChartVue.add_waterfall(self, e1, options)
    self:add("waterfall", e1, options);
end

function ChartVue.add_line_TODO(self, e1, options)
